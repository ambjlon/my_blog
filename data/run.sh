...
#sudo python insert_txtblog_2_mysql.py 'mac os x ssh to linux 使用 gnuplot'  '工程技术' 'gunplot linux' macox_ssh_linux_gnuplot_conf.md 
#sudo python insert_txtblog_2_mysql.py 'matlab封装DLL动态链接库 再用VS2010调用（matlab VS混合编程）'  '工程技术' 'matlab vs' matlab_dll.md 
#sudo python insert_txtblog_2_mysql.py 'matlab kl-divergence（KL散度）实现代码'  '算法' 'matlab KL距离' matlab_kl_distance.md 
...
#sudo python insert_txtblog_2_mysql.py 'linux 多版本python的默认调用' '工程技术' 'linux python' python_multi_version.md
#sudo python insert_txtblog_2_mysql.py 'xshell登录linux使用emacs backspace C-h 键触发帮助功能' '工程技术' 'xshell emacs linux mac' emacs_xshell_backspace_help.md
